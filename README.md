...
интерактивного подтверждения. Профили встроенного чата продолжают действовать
только внутри чата: если `chat.profileId=plan`, чат остаётся только для чтения;
для записи BSL и метаданных в чате выберите `build` в новом списке «Профиль»
над полем ввода. Выбор сохраняется в сессии этого окна и действует со следующего
хода чата, включая новый чат в том же окне.
