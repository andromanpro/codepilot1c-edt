...
public final class CodexOAuthConstants {
    ...
    public static final String DEFAULT_MODEL = "gpt-5.3-codex"; //$NON-NLS-1$
    ...
    public static final String[] KNOWN_MODELS = {
        "gpt-5.3-codex", //$NON-NLS-1$
        "gpt-5.2-codex", //$NON-NLS-1$
        "gpt-5-codex", //$NON-NLS-1$
        "gpt-5.1-codex", //$NON-NLS-1$
        "codex-mini-latest", //$NON-NLS-1$
        "gpt-5.3", //$NON-NLS-1$
        "gpt-5.4", //$NON-NLS-1$
        "gpt-5", //$NON-NLS-1$
    };
